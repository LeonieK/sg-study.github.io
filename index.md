...
<section id="datenschutz" style="padding: 2rem 1rem; max-width: 700px; margin: auto; border-top: 1px solid #eee;">
  ...
  Wir nehmen den Schutz deiner Gesundheitsdaten sehr ernst. Im Rahmen der Studie werden folgende Daten erhoben: [Auflistung].

  **Vollständige Datenschutzerklärung:**

  > Deine persönlichen Gesundheitsdaten werden gemäß DSGVO vertraulich behandelt, nur für Forschungszwecke verwendet und nicht an Dritte weitergegeben. Mehr Details findest du in unserer [Datenschutzerklärung](#).

  *(Hier kannst du den kompletten langform Text einfügen.)*
</section>
